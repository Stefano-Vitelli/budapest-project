  ...
  return ( 
    <div className="begining">
      ...
      <div className="paragraph">
        ...
        <h3 className='four-header'>
          Values
        </h3>
        <p className='second-paragraph'>  
          I believe that being dedicate, hard working, passionate about what you do and always keeping the best attitude into a working team, 
          is the key to face each project and create something really good. <br /><br />
